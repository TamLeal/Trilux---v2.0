            ...
            <TableRow key={material.id}>
              ...
              <TableCell>
                <Input
                  ...
                  onChange={(e) =>
                    setEditedMaterial({ ...editedMaterial, unit: e.target.value })
                  }
                />
              </TableCell>
              <TableCell>
                <Input
                  ...
                  onChange={(e) =>
                    setEditedMaterial({ ...editedMaterial, unitPrice: e.target.value })
                  }
                />
              </TableCell>
              <TableCell>
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              {(project.materials || []).filter((m) => m.quantity <= m.minQuantity)
                .length === 0 && (
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="mt-2">
                        ...
                        <Progress value={orcamentoUtilizado} className="h-2" />
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    R${' '}
                    {orcamentoDisponivel.toLocaleString('pt-BR', {
                      minimumFractionDigits: 2,
                    })}
                  </p>
                </div>
