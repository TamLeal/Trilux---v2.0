...
export default function FinancialManagement({ data }) {
  ...
  const upcomingPayments = [
    { id: 1, description: 'Fornecedor de Cimento', amount: 50000, dueDate: '2024-03-25' },
    { id: 2, description: 'Mão de obra - Março', amount: 80000, dueDate: '2024-03-30' },
  ];
    ...
    return (
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          <CardHeader>
            <CardTitle className="text-xl text-gray-800">Resumo Financeiro</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between text-lg text-gray-600">
                <span>Orçamento Total: R${project.budget.toLocaleString()}</span>
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          <CardHeader>
            <CardTitle className="text-xl text-gray-800">Registrar Nova Despesa</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          <CardHeader className="flex flex-row items-center space-x-2">
            ...
            <CardTitle className="text-xl text-gray-800">Documentos Fiscais</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          <CardHeader className="flex flex-row items-center space-x-2">
            ...
            <CardTitle className="text-xl text-gray-800">Orçado vs Realizado</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300">
          <CardHeader className="flex flex-row items-center space-x-2">
            ...
            <CardTitle className="text-xl text-gray-800">Alertas de Pagamentos</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
  ...
  return (
    <>
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Gestão Financeira</h2>
